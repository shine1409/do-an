                        ...
                        <div class="slider-for">
                            <div class="single-slide">
                                <div class="product-content">
                                    <img width="100px" class="mp"
                                        src="{{ asset('storage/images/' . $dishDetail->image) }}" alt="">
                                    <img class="pbadge" src="{{ asset('assets/client/images/icons/pbadge.png') }}"
                                        alt="">
                                </div>
                            </div>
                            <div class="single-slide">
                ...
                <ul class="nav" id="productDesTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <div class="nav-link active" id="des-tab" data-bs-toggle="tab" data-bs-target="#des"
                            role="tab" aria-controls="des" aria-selected="true">Mô tả</div>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <li class="nav-item" role="presentation">
                        <div class="nav-link" id="reviews-tab" data-bs-toggle="tab" data-bs-target="#reviews"
                            role="tab" aria-controls="reviews" aria-selected="false">Đánh giá</div>
                    </li>
                </ul>
                    ...
                    @foreach ($relatedDishes as $relatedDish)
                        <div class="col-xl-3 col-lg-3 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                            <div class="single-dishes">
                                <div class="dish-img">
                                    <img src="{{ asset('storage/images/' . $relatedDish->image) }}"
