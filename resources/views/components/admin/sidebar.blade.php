    ...
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{ route('table.list') }}">Danh sách SP</a></li>
                    <li><a href="{{ route('table.add') }}">Thêm Sản Phẩm</a></li>
                </ul>
            </li>
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                    <div class="menu-icon">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{ route('table-book.list') }}">Danh sách Kho</a></li>
                    <li><a href="{{ route('table-book.add') }}">Thêm Kho</a></li>
                </ul>
            </li>
            ...
            {{-- <ul aria-expanded="false">
                <li><a href="{{ route('voucher.list') }}">Danh sách khuyến mãi</a></li>
