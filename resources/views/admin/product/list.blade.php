                                        ...
                                        <tbody>
                                            @foreach ($productes as $product)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge light {{ $product->status == '0' ? 'badge-danger' : 'badge-success' }}">
                                                            {{ $product->status == '0' ? 'Hết món' : 'Còn món' }}
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item"
                                                                    href="{{ route('product.edit', $product->slug) }}">Chỉnh
                                                                    sửa</a>
                                                                <a class="dropdown-item" href="#"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#deleteModal{{ $product->slug }}">Xóa</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <!-- Delete Modal -->
                                                <div class="modal fade" id="deleteModal{{ $product->slug }}" tabindex="-1"
                                                    aria-labelledby="deleteModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="deleteModalLabel">Xóa Sản Phẩm
                                                                </h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                Bạn có chắc chắn muốn xóa SP này không?
                                                            </div>
