                            ...
                            <form action="{{ route('product.update', $product->slug) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="number" name="quantity" class="form-control" placeholder="Nhập số lượng" value="{{ old('quantity', $product->quantity) }}">
                                        @error('quantity')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if ($product->image)
                                            <div id="imagePreview" class="mt-3 position-relative">
                                                ...
                                                <img src="{{ asset('storage/images/' . $product->image) }}" alt="{{ $product->name }}" width="100" class="img-thumbnail">
                                            </div>
                                        @endif
                                        @error('image')
                                            <span class="text-danger">{{ $message }}</span>
