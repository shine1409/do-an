...
Route::get('chi-tiet-mon-an/{id}', [ProductController::class, 'productDetail'])->name('productDetail');
...
Route::get('bai-viet/{id}', [BlogDetailController::class, 'show'])->name('blog.detail');
...
Route::name('product.')->group(function () {
    Route::get('product', [AdminProductController::class, 'list'])->name('list')->middleware(['auth', 'role:admin,staff']);
    Route::get('product/add', [AdminProductController::class, 'add'])->name('add')->middleware(['auth', 'role:admin,staff']);
    Route::post('product/store', [AdminProductController::class, 'store'])->name('store')->middleware(['auth', 'role:admin,staff']);
    Route::get('product/edit/{slug}', [AdminProductController::class, 'edit'])->name('edit')->middleware(['auth', 'role:admin,staff']);
    Route::put('product/update/{slug}', [AdminProductController::class, 'update'])->name('update')->middleware(['auth', 'role:admin,staff']);
    Route::delete('product/delete/{slug}', [AdminProductController::class, 'delete'])->name('delete')->middleware(['auth', 'role:admin,staff']);
...
Route::name('Voucher.')->group(function () {
    Route::get('Voucher/list', [VoucherController::class, 'list'])->name('list')->middleware(['auth', 'role:admin']);
    Route::get('Voucher/add', [VoucherController::class, 'add'])->name('add')->middleware(['auth', 'role:admin']);
    Route::post('Voucher/store', [VoucherController::class, 'store'])->name('store')->middleware(['auth', 'role:admin']);
    Route::get('/Voucher/edit/{id}', [VoucherController::class, 'update'])->name('update')->middleware(['auth', 'role:admin']);
    Route::post('/Voucher/update/{id}', [VoucherController::class, 'processUpdate'])->name('processUpdate')->middleware(['auth', 'role:admin']);
    Route::delete('Voucher/{id}', [VoucherController::class, 'delete'])->name('delete')->middleware(['auth', 'role:admin']);
})->middleware(['auth', 'role:admin']);
